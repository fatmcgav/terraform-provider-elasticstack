...
type RuleResponseProperties struct {
	...
	ApiKeyOwner interface{} `json:"api_key_owner"`
	...
	NotifyWhen interface{} `json:"notify_when,omitempty"`
...
// SetNextRun gets a reference to the given interface{} and assigns it to the NextRun field.
...
// SetNotifyWhen gets a reference to the given interface{} and assigns it to the NotifyWhen field.
...
func (o RuleResponseProperties) ToMap() (map[string]interface{}, error) {
	...
	if o.ApiKeyOwner != nil {
		toSerialize["api_key_owner"] = o.ApiKeyOwner
	}
